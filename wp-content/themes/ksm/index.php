        ...
        <ul>
          ...
          <li data-transition="slideleft" data-slotamount="7" data-masterspeed="1500">
            ...
            <div class="jx-caption-big-2 tp-caption grey_regular_18 customin tp-resizeme rs-parallaxlevel-0"
              ...
              data-elementdelay="0.05"
              data-endelementdelay="0.1"
              style="z-index: 9">Колесный экскаватор представляет собой мощную и высокопроизводительную<br>спецтехнику, отличающуюся внушительными габаритами и решающую большой<br>спектр рабочих вопросов и задач. Его применяют в разработке котлованов и<br> карьеров, выкапывании ям и траншей, создании насыпей, а также в погрузке и разгрузке различных типов строительных материалов.
            </div>
            <!-- LAYER NR. 3 -->
          </li>
          <!-- SLIDE#1 -->
    ...
    <div role="main" class="main no-top-padding">
       ...
       <div class="jx-container jx-white-bg jx-container-badge">
        	...
        	<div class="jx-row-badge">
            	...
            	<div class="jx-badge-text">Projects</div>
            ...
            <div class="container container-margin jx-padding"> 
                ...
                <div class="jx-section-title-1">            
                    ...
                    <div class="jx-title-position">
                        ...
                        <div class="jx-title jx-uppercase">Our Projects</div>
                ...
                <div class="jx-protfolio">
                    ...
                    <div class="jx-portfolio-filter category-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="#" data-filter=".maintenance">House Maintenance</a></li>

                            <li><a href="#" data-filter=".interior">Interior</a></li>

                            <li><a href="#" data-filter=".woodwork">Wood Work</a></li>
                                    ...
                                    <div class="jx-portfolio-hoverlayer"></div>
                                        ...
                                        <div class="jx-portfolio-hover">
                                            ...
                                            <div class="jx-portfolio-top-hover">
                                               ...
                                               <div class="jx-title jx-uppercase">Lorem Ipsum</div>                                                
       	...
       	<div  class="jx-container jx-grey-bg jx-padding">
				...
				<div class="container">
                    ...
                    <div class="jx-counter-up-2">
						...
						<div class="jx-title"><i class="fa fa-clock-o"></i><span class="title">Safely Completed Hours</span></div>
		...
		<!-- BDF PROJECT IN PROGRESS-->        
        	...
        	<div class="jx-row-badge">
            	<div class="jx-badge-text">WIP</div>
            	<div class="jx-badge-shape"></div>
            </div>
            ...
            <div class="container jx-padding"> 
                <div class="jx-section-title-1">            
                    ...
                    <div class="jx-title-position">
                        <div class="jx-left-border"></div>
                        <div class="jx-title jx-uppercase">Projects in Progress</div>
                        <div class="jx-right-border"></div>
                    </div>
                    <div class="jx-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</div>  
                </div> 
                    ...
                    <div class="eight columns">                
                        <div class="item">
                            ...
                            <div class="jx-project-view-contents">
                            	...
                            	<div class="title">Amwaj Village</div>
                                <!-- Title -->
                                <div class="skillbar">
                                ...
                                <ul class="jx-bg-alternate">
                                    <li><strong>Contractor :</strong> Varullm</li>
                                    <li><strong>Area :</strong> 2343 sqm</li>
                                    <li><strong>Location:</strong> Van Venue, Paradise 245 CA</li>
                                    <li><strong>Completaion Exp:</strong> 2017</li>
                                </ul>
                            	<!-- Details -->                               
                            </div>
                            <!-- Right Position -->
                    ...
                    <div class="one-third columns">
                        ...
                        <div class="item">
                            ...
                            <div class="jx-project-contents">
                            	...
                            	<div class="title">Zawya Buildings</div>
                                <!-- Title -->
                                <div class="skillbar">
                                    <div class="percent-bg" style="width:60%;"></div>
                                </div>
                                ...
                                <li><strong>Contractor :</strong> Varullm</li>
                                <li><strong>Area :</strong> 2343 sqm</li>
                                <li><strong>Year Exp:</strong> 2017</li>
                                </ul>
                            	<!-- Details -->                               
                            </div>
                            <!-- Right Position -->
                    ...
                    <div class="one-third columns">
                        ...
                        <div class="item">
                            ...
                            <div class="jx-project-contents">
                            	...
                            	<div class="title">Talla Avenue</div>
                                <!-- Title -->
                                <div class="skillbar">
                                    <div class="percent-bg" style="width:60%;"></div>
                                </div>
                    ...
                    <div class="one-third columns">
                        ...
                        <div class="item">
                            ...
                            <div class="jx-project-contents">
                            	...
                            	<div class="title">Caren Valley</div>
                                <!-- Title -->
                                <div class="skillbar">
                                    <div class="percent-bg" style="width:60%;"></div>
                                </div>
        ...
        <div class="jx-container jx-padding jx-white-bg">
            ...
            <div class="container">
                ...
                <div class="jx-section-title-2">
                    ...
                    <div class="jx-title jx-uppercase">Our Clients</div>
                ...
                <div class="eight columns">
                    ...
                    <div class="jx-section-title-2">
                        ...
                        <div class="jx-title jx-uppercase">Testimonials</div>
