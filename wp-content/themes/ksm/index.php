        ...
        <ul>
          ...
          <li data-transition="slideleft" data-slotamount="7" data-masterspeed="1500">
            ...
            <div class="jx-caption-big-2 tp-caption grey_regular_18 customin tp-resizeme rs-parallaxlevel-0"
              ...
              data-elementdelay="0.05"
              data-endelementdelay="0.1"
              style="z-index: 9">Колесный экскаватор представляет собой мощную и высокопроизводительную<br>спецтехнику, отличающуюся внушительными габаритами и решающую большой спектр рабочих вопросов и задач.<br>Его применяют в разработке котлованов и карьеров, выкапывании ям и траншей, создании насыпей, а также в погрузке и разгрузке различных типов строительных материалов.
            </div>
            <!-- LAYER NR. 3 -->
          </li>
          <!-- SLIDE#1 -->
