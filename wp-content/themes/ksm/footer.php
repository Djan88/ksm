                ...
                <div class="jx-footer-address">
                  <ul>
                    <li>
                      ...
                      <div>РФ, Москва, ул. Центральная, 15</div>
                    </li>
                  </ul>
                </div>
                <!-- Contact Address -->
                ...
                <div class="jx-footer-address">
                  <ul>
                    <li>
                      ...
                      <div class="tel"><strong>Tel :</strong>  8(495) - 3426 - 3211223</div>
                      <div class="fax"><strong>Fax :</strong> 8(495) - 3426 - 3211223</div>
                    </li>
                  </ul>
                </div>
                <!-- Contact Address -->
                ...
                <div class="jx-footer-address">
                  <ul>
                    <li>
                      ...
                      <div class="email"><strong>Email :</strong> company@your-company.com</div>
                    </li>
                  </ul>
                </div>
                <!-- Contact Address -->
